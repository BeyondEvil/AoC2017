def run_it_a(passwords):
    rows = passwords.split('\n')
    print "total number of phrases: ", len(rows)
    valid_phrases = 0
    for row in rows:
        words = row.split(' ')
        num_words = len(words)
    ...
    print "Number of valid phrases: ", valid_phrases
    return valid_phrases


def run_it_b(passwords):
    rows = passwords.split('\n')
    print "total number of phrases: ", len(rows)
    valid_phrases = []
    for row in rows:
    ...
    print "Number of valid phrases: ", len(sorted_valid_phrases)
    return valid_phrases


if __name__ == '__main__':
    passwords = """nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
